...
- ## Coding Test Platform <!-- :pencil2: [풀이]() :computer: [코드]() -->
  ...
  - ## Programmers
    ...
    - ### Level1
      ...
      - #### 가운데 글자 가져오기 <!-- :pencil2: [풀이]() --> :computer: [코드](https://github.com/PhilosopherProgrammer/CodingTestPractice/tree/main/CodingTestPlatform/Programmers/Level1/%EA%B0%80%EC%9A%B4%EB%8D%B0%EA%B8%80%EC%9E%90%EA%B0%80%EC%A0%B8%EC%98%A4%EA%B8%B0)
      - #### 같은 숫자는 싫어 <!-- :pencil2: [풀이]() :computer: [코드]() -->
      - #### 나누어 떨어지는 숫자 배열 <!-- :pencil2: [풀이]() :computer: [코드]() -->
      - #### 나머지가 1이 되는 수 찾기 <!-- :pencil2: [풀이]() --> :computer: [코드](https://github.com/PhilosopherProgrammer/CodingTestPractice/tree/main/CodingTestPlatform/Programmers/Level1/%EB%82%98%EB%A8%B8%EC%A7%80%EA%B0%801%EC%9D%B4%EB%90%98%EB%8A%94%EC%88%98%EC%B0%BE%EA%B8%B0)
      ...
      - #### 두 정수 사이의 합 <!-- :pencil2: [풀이]() :computer: [코드]() -->
      ...
      - #### 부족한 금액 계산하기
      - #### 서울에서 김서방 찾기 <!-- :pencil2: [풀이]() --> :computer: [코드](https://github.com/PhilosopherProgrammer/CodingTestPractice/tree/main/CodingTestPlatform/Programmers/Level1/%EC%84%9C%EC%9A%B8%EC%97%90%EC%84%9C%EA%B9%80%EC%84%9C%EB%B0%A9%EC%B0%BE%EA%B8%B0)
      ...
      - #### 약수의 개수와 덧셈 <!-- :pencil2: [풀이]() :computer: [코드]() -->
      ...
      - #### 최소 직사각형 <!-- :pencil2: [풀이]() :computer: [코드]() -->
